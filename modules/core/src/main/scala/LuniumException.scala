...
sealed abstract class NavigationException(message:String) extends LuniumException(message)
sealed abstract class SearchElementException(message:String) extends LuniumException(message)
sealed abstract class InteractElementException(message:String) extends LuniumException(message)

//low level exceptions
class ElementClickInterceptedException(message:String) extends InteractElementException(message)
class ElementNotInteractableException(message:String)  extends InteractElementException(message)

class InsecureCertificateException(message:String) extends NavigationException(message)
...
class InvalidElementStateException(message:String) extends InteractElementException(message)
class InvalidSelectorException(message:String)    extends SearchElementException(message)
...
class NoSuchElementException(message:String) extends SearchElementException(message)
...
class StaleElementReferenceException(message:String) extends LuniumException(message)
class TimeoutException(message:String) extends NavigationException(message)
...
class HttpUnauthorizedException(message:String) extends NavigationException(message)
